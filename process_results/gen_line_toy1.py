...
if __name__ == "__main__":    
    ...
    f =  open('./process_results/gen_line_toy.yaml', 'r')
    ...
    plt.xlabel(plot_settings_this['x_label'])
    plt.ylabel(plot_settings_this['y_label'][opts.term])
    ...
    plt.savefig('./figures/{}.{}'.format(
        plot_settings_this['output'][opts.term], opts.suffix), dpi = opts.dpi)
    plt.close()
    '''
