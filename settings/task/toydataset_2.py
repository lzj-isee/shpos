...
class args(object):
    def __init__(self, parser):
        self.parser = parser
        parser.add_argument('--var1', type = float, default = 2.5)
        parser.add_argument('--var2', type = float, default = 4)
        parser.add_argument('--cov', type = float, default = - 0.98 * 3)
        parser.add_argument('--mean_11', type = float, default = 2.5)
        parser.add_argument('--mean_12', type = float, default = 0)
        parser.add_argument('--mean_21', type = float, default = 2.5)
        parser.add_argument('--mean_22', type = float, default = 0)
        ...
        parser.add_argument('--init_mean_1', type = float, default = -4)
        parser.add_argument('--init_mean_2', type = float, default = -4)
