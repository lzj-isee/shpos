...
for lr in lr_s:
    os.system('python3 main.py --algorithm SVGD --gpu_ids 3 --save_folder results \
        --task fnn2_regression_g --dataset cadata --eval_interval 10 \
...
'''
for i in range(0, 20):
    os.system('python3 main.py --algorithm SVGD --gpu_ids 1 --save_folder results_cadata \
        --task fnn2_regression_g --dataset cadata --eval_interval 10 \
        --iters 5001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 1.5e-5 '.format(i))
    os.system('python3 main.py --algorithm SPOS --gpu_ids 1 --save_folder results_cadata \
        --task fnn2_regression_g --dataset cadata --eval_interval 10 \
        --iters 5001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 7e-6 --beta 10'.format(i))
    os.system('python3 main.py --algorithm SPOSHMC2 --gpu_ids 1 --save_folder results_cadata \
        --task fnn2_regression_g --dataset cadata --eval_interval 10 \
        --iters 5001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 1.6e-4 --weight 5 --ge 0.01 --u 1'.format(i))
    os.system('python3 main.py --algorithm WNes --gpu_ids 1 --save_folder results_cadata \
        --task fnn2_regression_g --dataset cadata --eval_interval 10 \
        --iters 5001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
