...
lr_SVRGPOS, beta_SVRGPOS = [6e-5], [4]
lr_WNes, accShrink_WNes, accHessBnd_WNes = [6e-6], [0.2], [3e2]
lr_HMCSPOS, weight_HMCSPOS, ge_HMCSPOS, u_HMCSPOS = [3e-4], [5], [0.02], [1]
lr_STORMSPOS, weight_STORMSPOS, ge_STORMSPOS, u_STORMSPOS, refresh_value_STORMSPOS, pow_STORMSPOS = \
    [3e-4], [5], [0.02], [1], 5000, 0.4
lr_ParaHMC, ge_ParaHMC, u_ParaHMC = [3e-4], [0.02], [1]
lr_ParaStormHMC, ge_ParaStormHMC, u_ParaStormHMC, refresh_value_ParaStormHMC, pow_ParaStormHMC = \
    [3e-4], [0.02], [1], 5000, 0.4
# abalone trian_num 4177*0.8
command = 'python3 main.py --gpu_ids 3 --save_folder results --task fnn2_regression --dataset abalone \
    --eval_interval 5 --epochs 40 --particle_num 20 --batch_size 32 --kernel_h 0.33 --seed 0 '
command_SVRG = 'python3 main.py --gpu_ids 3 --save_folder results --task fnn2_regression --dataset abalone \
...
if run_all:
    for i in range(0, 20): 
        #os.system('python3 main.py --algorithm SVGD --gpu_ids 1 --save_folder results_abalone \
        #    --task fnn2_regression --dataset abalone --eval_interval 5 \
        #    --epochs 40 --particle_num 20 --batch_size 32 --kernel_h 0.33 \
        #    --seed {} --lr 4e-5 '.format(i)) 

        #os.system('python3 main.py --algorithm SPOS --gpu_ids 1 --save_folder results_abalone \
        #    --task fnn2_regression --dataset abalone --eval_interval 5 \
        #    --epochs 40 --particle_num 20 --batch_size 32 --kernel_h 0.33 \
        #    --seed {} --lr 1e-5 --beta 4'.format(i)) 

        #os.system('python3 main.py --algorithm SVRGPOS --gpu_ids 2 --save_folder results_abalone \
        #    --task fnn2_regression --dataset abalone --eval_interval 5 \
        #    --epochs 20 --particle_num 20 --batch_size 32 --kernel_h 0.33 \
        #    --seed {} --lr 6e-5 --beta 4'.format(i)) 

        #os.system('python3 main.py --algorithm WNes --gpu_ids 1 --save_folder results_abalone \
        #    --task fnn2_regression --dataset abalone --eval_interval 5 \
        #    --epochs 40 --particle_num 20 --batch_size 32 --kernel_h 0.33 \
        #    --seed {} --lr 6e-6 --accShrink 0.2 --accHessBnd 3e2'.format(i))

        #os.system('python3 main.py --algorithm HMCSPOS --gpu_ids 1 --save_folder results_abalone \
        #    --task fnn2_regression --dataset abalone --eval_interval 5 \
        #    --epochs 40 --particle_num 20 --batch_size 32 --kernel_h 0.33 \
        #    --seed {} --lr 3.4e-4 --weight 5 --ge 0.02 --u 1'.format(i)) 

        #os.system('python3 main.py --algorithm STORMSPOS --gpu_ids 1 --save_folder results_abalone \
        #    --task fnn2_regression --dataset abalone --eval_interval 5 \
        #    --epochs 40 --particle_num 20 --batch_size 32 --kernel_h 0.33 \
        #    --refresh_value 5000 --pow 0.4 \
        #    --seed {} --lr 3.4e-4 --weight 5 --ge 0.02 --u 1'.format(i)) 

        os.system('python3 main.py --algorithm ParaHMC --gpu_ids 1 --save_folder results_abalone \
            --task fnn2_regression --dataset abalone --eval_interval 5 \
            --epochs 40 --particle_num 20 --batch_size 32 --kernel_h 0.33 \
            --seed {} --lr 3.4e-4 --ge 0.02 --u 1'.format(i)) 

        os.system('python3 main.py --algorithm ParaStormHMC --gpu_ids 1 --save_folder results_abalone \
            --task fnn2_regression --dataset abalone --eval_interval 5 \
            --epochs 40 --particle_num 20 --batch_size 32 --kernel_h 0.33 \
            --refresh_value 5000 --pow 0.4 \
            --seed {} --lr 3.4e-4 --ge 0.02 --u 1'.format(i)) 