...
run_all = False
lr_SVGD = [6e-6]
lr_SPOS, beta_SPOS = [3.4e-6], [15]
lr_SVRGPOS, beta_SVRGPOS = [1.1e-5], [15]
lr_WNes, accShrink_WNes, accHessBnd_WNes = [1.2e-7], [0.2], [3e2]
lr_HMCSPOS, weight_HMCSPOS, ge_HMCSPOS, u_HMCSPOS = [1.0e-4], [10], [0.01], [1]
lr_STORMSPOS, weight_STORMSPOS, ge_STORMSPOS, u_STORMSPOS, refresh_value_STORMSPOS, pow_STORMSPOS = \
    [1.0e-4], [10], [0.008], [1], 5000, 0.3
lr_ParaHMC, ge_ParaHMC, u_ParaHMC = [0.9e-4], [0.01], [1]
lr_ParaStormHMC, ge_ParaStormHMC, u_ParaStormHMC, refresh_value_ParaStormHMC, pow_ParaStormHMC = \
    [1.0e-4], [0.01], [1], 5000, 0.3
# superconduct trian_num 21264*0.8
command = 'python3 main.py --gpu_ids 3 --save_folder results --task fnn2_regression --dataset superconduct \
    --eval_interval 10 --epochs 30 --particle_num 20 --batch_size 100 --kernel_h 0.33 --seed 0 '
command_SVRG = 'python3 main.py --gpu_ids 3 --save_folder results --task fnn2_regression --dataset superconduct \
...
if run_all:
    for i in range(0, 20): 
        ...
        os.system('python3 main.py --algorithm SVGD --gpu_ids 1 --save_folder results_superconduct \
            --task fnn2_regression --dataset superconduct --eval_interval 10 \
        ...
        os.system('python3 main.py --algorithm SVRGPOS --gpu_ids 1 --save_folder results_superconduct \
            --task fnn2_regression --dataset superconduct --eval_interval 10 \
            --epochs 15 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
            --seed {} --lr 1.1e-5 --beta 15'.format(i)) 
        ...
        os.system('python3 main.py --algorithm HMCSPOS --gpu_ids 1 --save_folder results_superconduct \
            --task fnn2_regression --dataset superconduct --eval_interval 10 \
            --epochs 30 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
            --seed {} --lr 1.0e-4 --weight 10 --ge 0.01 --u 1'.format(i)) 

        os.system('python3 main.py --algorithm STORMSPOS --gpu_ids 1 --save_folder results_superconduct \
            --task fnn2_regression --dataset superconduct --eval_interval 10 \
            --epochs 30 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
            --refresh_value 5000 --pow 0.3 \
            --seed {} --lr 1.0e-4 --weight 10 --ge 0.008 --u 1'.format(i)) 
        '''
        os.system('python3 main.py --algorithm ParaHMC --gpu_ids 1 --save_folder results_superconduct \
            --task fnn2_regression --dataset superconduct --eval_interval 10 \
            --epochs 30 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
            --seed {} --lr 0.9e-4 --ge 0.01 --u 1'.format(i)) 

        os.system('python3 main.py --algorithm ParaStormHMC --gpu_ids 1 --save_folder results_superconduct \
            --task fnn2_regression --dataset superconduct --eval_interval 10 \
            --epochs 30 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
            --refresh_value 5000 --pow 0.3 \
            --seed {} --lr 1.0e-4 --ge 0.01 --u 1'.format(i)) 
