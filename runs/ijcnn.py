...
run_all = True
lr_SVGD = [1.6e-4]
lr_SPOS, beta_SPOS = [2e-4], [10]
lr_SVRGPOS, beta_SVRGPOS = [6e-4], [10]
lr_WNes, accShrink_WNes, accHessBnd_WNes = [2e-4], [0.2], [3e2]
lr_HMCSPOS, weight_HMCSPOS, ge_HMCSPOS, u_HMCSPOS = [5e-4], [20], [0.01], [1]
lr_STORMSPOS, weight_STORMSPOS, ge_STORMSPOS, u_STORMSPOS, refresh_value_STORMSPOS, pow_STORMSPOS = \
    [5e-4], [20], [0.01], [1], 10000, 1
lr_ParaHMC, ge_ParaHMC, u_ParaHMC = [6e-4], [0.01], [1]
lr_ParaStormHMC, ge_ParaStormHMC, u_ParaStormHMC, refresh_value_ParaStormHMC, pow_ParaStormHMC = \
    [8e-4], [0.01], [1], 10000, 1
# ijcnn trian_num 49990
command = 'python3 main.py --gpu_ids 3 --save_folder results --task logistic_regression --dataset ijcnn \
    --eval_interval 10 --epochs 20 --particle_num 50 --batch_size 100 --kernel_h 0.25 --seed 0 '
command_SVRG = 'python3 main.py --gpu_ids 3 --save_folder results --task logistic_regression --dataset ijcnn \
...
if run_all:
    for i in range(0, 20): 
        '''
        os.system('python3 main.py --algorithm SVGD --gpu_ids 2 --save_folder results_ijcnn \
            --task logistic_regression --dataset ijcnn --eval_interval 10 \
            --epochs 20 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
            --seed {} --lr 1.6e-4 '.format(i)) 
        os.system('python3 main.py --algorithm SPOS --gpu_ids 2 --save_folder results_ijcnn \
            --task logistic_regression --dataset ijcnn --eval_interval 10 \
            --epochs 20 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
            --seed {} --lr 2e-4 --beta 10'.format(i)) 
        os.system('python3 main.py --algorithm SVRGPOS --gpu_ids 2 --save_folder results_ijcnn \
            --task logistic_regression --dataset ijcnn --eval_interval 10 \
            --epochs 10 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
            --seed {} --lr 6e-4 --beta 10'.format(i)) 
        os.system('python3 main.py --algorithm WNes --gpu_ids 2 --save_folder results_ijcnn \
            --task logistic_regression --dataset ijcnn --eval_interval 10 \
            --epochs 20 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
            --seed {} --lr 2e-4 --accShrink 0.2 --accHessBnd 3e2'.format(i))
        os.system('python3 main.py --algorithm HMCSPOS --gpu_ids 2 --save_folder results_ijcnn \
            --task logistic_regression --dataset ijcnn --eval_interval 10 \
            --epochs 20 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
            --seed {} --lr 5e-4 --weight 20 --ge 0.01 --u 1'.format(i)) 
        os.system('python3 main.py --algorithm STORMSPOS --gpu_ids 2 --save_folder results_ijcnn \
            --task logistic_regression --dataset ijcnn --eval_interval 10 \
            --epochs 20 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
            --refresh_value 10000 --pow 1 \
            --seed {} --lr 5e-4 --weight 20 --ge 0.01 --u 1'.format(i)) 
        '''
        os.system('python3 main.py --algorithm ParaHMC --gpu_ids 2 --save_folder results_ijcnn \
            --task logistic_regression --dataset ijcnn --eval_interval 10 \
            --epochs 20 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
            --seed {} --lr 6e-4 --ge 0.01 --u 1'.format(i)) 
        os.system('python3 main.py --algorithm ParaStormHMC --gpu_ids 2 --save_folder results_ijcnn \
            --task logistic_regression --dataset ijcnn --eval_interval 10 \
            --epochs 20 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
            --refresh_value 10000 --pow 1 \
            --seed {} --lr 8e-4 --ge 0.01 --u 1'.format(i)) 