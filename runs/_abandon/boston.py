...
for lr in lr_s:
    os.system('python3 main.py --algorithm SVGD --gpu_ids 3 --save_folder results \
        --task fnn2_regression --dataset boston --eval_interval 10 \
...
for i in range(0, 20): 
    os.system('python3 main.py --algorithm SVGD --gpu_ids 2 --save_folder results_boston \
        --task fnn2_regression --dataset boston --eval_interval 10 \
        --iters 3001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 2e-4 '.format(i)) 
    os.system('python3 main.py --algorithm SPOS --gpu_ids 2 --save_folder results_boston \
        --task fnn2_regression --dataset boston --eval_interval 10 \
        --iters 3001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 2e-5 --beta 1'.format(i)) 
    os.system('python3 main.py --algorithm SPOSHMC2 --gpu_ids 2 --save_folder results_boston \
        --task fnn2_regression --dataset boston --eval_interval 10 \
        --iters 3001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 3e-3 --weight 0.4 --ge 0.06 --u 0.2'.format(i)) 
    os.system('python3 main.py --algorithm WNes --gpu_ids 2 --save_folder results_boston \
        --task fnn2_regression --dataset boston --eval_interval 10 \
        --iters 3001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
