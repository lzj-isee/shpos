...
for lr in lr_s:
    os.system('python3 main.py --algorithm SVGD --gpu_ids 3 --save_folder results \
        --task fnn2_regression --dataset online --eval_interval 20 \
...
for i in range(0, 20): 
    os.system('python3 main.py --algorithm SVGD --gpu_ids 2 --save_folder results_online \
        --task fnn2_regression --dataset online --eval_interval 20 \
        --iters 10001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 8e-5 '.format(i)) 
    os.system('python3 main.py --algorithm SPOS --gpu_ids 2 --save_folder results_online \
        --task fnn2_regression --dataset online --eval_interval 20 \
        --iters 10001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 2e-5 --beta 4'.format(i)) 
    os.system('python3 main.py --algorithm SPOSHMC2 --gpu_ids 2 --save_folder results_online \
        --task fnn2_regression --dataset online --eval_interval 20 \
        --iters 10001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 1.6e-5 --weight 10 --ge 0.001 --u 1'.format(i)) 
    os.system('python3 main.py --algorithm WNes --gpu_ids 2 --save_folder results_online \
        --task fnn2_regression --dataset online --eval_interval 20 \
        --iters 10001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 1e-8 --accShrink 0.2 --accHessBnd 3e2'.format(i))
