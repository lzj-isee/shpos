...
for lr in lr_s:
    os.system('python3 main.py --algorithm SVGD --gpu_ids 3 --save_folder results \
        --task logistic_regression --dataset mushrooms --eval_interval 5 --split_seed 9 \
        --iters 1501 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
        --seed 0 --lr {}'.format(lr)) 
...
'''
for i in range(0, 20): 
    #os.system('python3 main.py --algorithm SVGD --gpu_ids 3 --save_folder results_mushrooms \
    #    --task logistic_regression --dataset mushrooms --eval_interval 5 --split_seed 9 \
    #    --iters 1501 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
    #    --seed {} --lr 8e-6 '.format(i)) 
    #os.system('python3 main.py --algorithm SPOS --gpu_ids 3 --save_folder results_mushrooms \
    #    --task logistic_regression --dataset mushrooms --eval_interval 5 --split_seed 9 \
    #    --iters 1501 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
    #    --seed {} --lr 6e-6 --beta 5'.format(i)) 
    #os.system('python3 main.py --algorithm SPOSHMC2 --gpu_ids 3 --save_folder results_mushrooms \
    #    --task logistic_regression --dataset mushrooms --eval_interval 5 --split_seed 9 \
    #    --iters 1501 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
    #    --seed {} --lr 7e-4 --weight 20 --ge 0.01 --u 0.1'.format(i)) 
    #os.system('python3 main.py --algorithm WNes --gpu_ids 2 --save_folder results_mushrooms \
    #    --task logistic_regression --dataset mushrooms --eval_interval 5 --split_seed 9 \
    #    --iters 1501 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
