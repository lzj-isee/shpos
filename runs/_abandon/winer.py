...
for lr in lr_s:
    os.system('python3 main.py --algorithm SVGD --gpu_ids 3 --save_folder results \
        --task fnn2_regression --dataset WineRed --eval_interval 10 \
...
'''
for i in range(0, 20): 
    os.system('python3 main.py --algorithm SVGD --gpu_ids 2 --save_folder results_WineRed \
        --task fnn2_regression --dataset WineRed --eval_interval 10 \
        --iters 5001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 8e-5 '.format(i)) 
    os.system('python3 main.py --algorithm SPOS --gpu_ids 2 --save_folder results_WineRed \
        --task fnn2_regression --dataset WineRed --eval_interval 10 \
        --iters 5001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 2e-5 --beta 4'.format(i)) 
    os.system('python3 main.py --algorithm SPOSHMC2 --gpu_ids 2 --save_folder results_WineRed \
        --task fnn2_regression --dataset WineRed --eval_interval 10 \
        --iters 5001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
        --seed {} --lr 4e-4 --weight 5 --ge 0.02 --u 1'.format(i)) 
    os.system('python3 main.py --algorithm WNes --gpu_ids 2 --save_folder results_WineRed \
        --task fnn2_regression --dataset WineRed --eval_interval 10 \
        --iters 5001 --particle_num 20 --batch_size 100 --kernel_h 0.33 \
