...
for lr in lr_s:
    os.system('python3 main.py --algorithm SVGD --gpu_ids 3 --save_folder results \
        --task logistic_regression --dataset codrna --eval_interval 20 \
...
'''
for i in range(0, 20): 
    os.system('python3 main.py --algorithm SVGD --gpu_ids 2 --save_folder results_codrna \
        --task logistic_regression --dataset codrna --eval_interval 20 \
        --iters 10001 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
        --seed {} --lr 6e-5 '.format(i)) 
    os.system('python3 main.py --algorithm SPOS --gpu_ids 2 --save_folder results_codrna \
        --task logistic_regression --dataset codrna --eval_interval 20 \
        --iters 10001 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
        --seed {} --lr 1e-5 --beta 2'.format(i)) 
    os.system('python3 main.py --algorithm SPOSHMC2 --gpu_ids 2 --save_folder results_codrna \
        --task logistic_regression --dataset codrna --eval_interval 20 \
        --iters 10001 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
        --seed {} --lr 8e-4 --weight 10 --ge 0.1 --u 1'.format(i)) 
    os.system('python3 main.py --algorithm WNes --gpu_ids 2 --save_folder results_codrna \
        --task logistic_regression --dataset codrna --eval_interval 20 \
        --iters 10001 --particle_num 50 --batch_size 100 --kernel_h 0.25 \
